...
Этот раздел важен, потому что discoverability растет только тогда, когда thin pages, массовый AI-контент, блокировки ботов, ложные сигналы управляются как единая система исполнения, а не как набор разрозненных задач.

## Когда Использовать

Используйте его для сценариев: любая discoverability-программа. Ставьте в приоритет в начале, если сайт запускается, перезапускается или выходит из просадки трафика и доверия.
...
2. Разбейте работу на действия вокруг: thin pages, массовый AI-контент, блокировки ботов, ложные сигналы.
...
Задача: составь action plan для раздела Риски и анти-паттерны с приоритетами, QA-шагами, рисками и expected outputs.
...
Пример AI Агентство сначала применяет раздел Риски и анти-паттерны к аудиту, GEO-страницам услуг и брендовым AI-промптам, а уже потом масштабирует на весь блог.
