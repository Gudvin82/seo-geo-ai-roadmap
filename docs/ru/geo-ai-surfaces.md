...
## Surface-specific view

| Surface | Practical behavior | Что помогает | Boundary |
|---|---|---|---|
| ChatGPT browsing/search | сочетает browsing, summarization и source selection | clean facts, answer-ready sections, strong source pages | нет гарантированного citation path |
...
- факты согласованы между homepage, about, FAQ и service pages
- structured data усиливает entity mapping
- proof assets снижают риск hallucination

## Что различается по площадкам
