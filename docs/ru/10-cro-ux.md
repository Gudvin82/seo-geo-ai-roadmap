...
Этот раздел важен, потому что discoverability растет только тогда, когда ясность CTA, proof, возражения, формы, conversion paths управляются как единая система исполнения, а не как набор разрозненных задач.

## Когда Использовать

Используйте его для сценариев: лидоген и коммерческие сайты. Ставьте в приоритет в начале, если сайт запускается, перезапускается или выходит из просадки трафика и доверия.
...
2. Разбейте работу на действия вокруг: ясность CTA, proof, возражения, формы, conversion paths.
...
Задача: составь action plan для раздела CRO и UX с приоритетами, QA-шагами, рисками и expected outputs.
...
Пример AI Агентство сначала применяет раздел CRO и UX к аудиту, GEO-страницам услуг и брендовым AI-промптам, а уже потом масштабирует на весь блог.
