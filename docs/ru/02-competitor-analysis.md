...
Этот раздел важен, потому что discoverability растет только тогда, когда SERP-конкуренты, AI-цитирование, gap по офферу и авторитету управляются как единая система исполнения, а не как набор разрозненных задач.

## Когда Использовать

Используйте его для сценариев: конкурентные ниши и новые категории. Ставьте в приоритет в начале, если сайт запускается, перезапускается или выходит из просадки трафика и доверия.
...
2. Разбейте работу на действия вокруг: SERP-конкуренты, AI-цитирование, gap по офферу и авторитету.
...
Задача: составь action plan для раздела Анализ конкурентов с приоритетами, QA-шагами, рисками и expected outputs.
...
Пример AI Агентство сначала применяет раздел Анализ конкурентов к аудиту, GEO-страницам услуг и брендовым AI-промптам, а уже потом масштабирует на весь блог.
