...
Этот раздел важен, потому что discoverability растет только тогда, когда критерии завершения для страниц, релизов, QA и измеримости управляются как единая система исполнения, а не как набор разрозненных задач.

## Когда Использовать

Используйте его для сценариев: любая команда, которая регулярно релизит. Ставьте в приоритет в начале, если сайт запускается, перезапускается или выходит из просадки трафика и доверия.
...
3. Разбейте работу на действия вокруг: критерии завершения для страниц, релизов, QA и измеримости.
...
Задача: составь action plan для раздела Definition of Done с приоритетами, QA-шагами, рисками и expected outputs.
...
Пример AI Агентство сначала применяет раздел Definition of Done к аудиту, GEO-страницам услуг и брендовым AI-промптам, а уже потом масштабирует на весь блог.
