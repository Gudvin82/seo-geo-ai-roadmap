...
This section matters because discoverability grows only when offers, ICP, JTBD, unit economics, funnel assumptions are handled as an execution system rather than isolated tasks.

## When to Use

Use it for all markets. Prioritize it early if the site is launching, relaunching, or recovering from a traffic or trust problem.
...
2. Break the work into actions around offers, ICP, JTBD, unit economics, funnel assumptions.
...
Task: produce an action plan for Business Strategy with priorities, QA steps, risks, and expected outputs.
...
Example AI Agency applies Business Strategy first to audit, GEO service pages, and branded AI prompts before scaling to the full blog.
