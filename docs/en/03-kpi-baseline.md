...
This section matters because discoverability grows only when traffic, leads, sales, brand demand, AI share of voice are handled as an execution system rather than isolated tasks.

## When to Use

Use it for all programs that need reporting discipline. Prioritize it early if the site is launching, relaunching, or recovering from a traffic or trust problem.
...
2. Break the work into actions around traffic, leads, sales, brand demand, AI share of voice.
...
Task: produce an action plan for KPI and Baseline with priorities, QA steps, risks, and expected outputs.
...
Example AI Agency applies KPI and Baseline first to audit, GEO service pages, and branded AI prompts before scaling to the full blog.
