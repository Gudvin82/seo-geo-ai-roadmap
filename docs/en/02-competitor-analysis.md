...
> **Tags:** [U] [AI/GEO]  
> **Priority:** High  
> **Roadmap phase:** Month 0-1

## Why It Matters

This section matters because discoverability grows only when SERP competitors, AI citations, offer gaps, authority gaps are handled as an execution system rather than isolated tasks.

## When to Use

Use it for competitive categories and new niches. Prioritize it early if the site is launching, relaunching, or recovering from a traffic or trust problem.
...
2. Break the work into actions around SERP competitors, AI citations, offer gaps, authority gaps.
...
Task: produce an action plan for Competitor Analysis with priorities, QA steps, risks, and expected outputs.
...
Example AI Agency applies Competitor Analysis first to audit, GEO service pages, and branded AI prompts before scaling to the full blog.
