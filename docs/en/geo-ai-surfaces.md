...
| Surface | Practical behavior | What helps | Boundary |
|---|---|---|---|
| ChatGPT browsing/search | combines browsing, summarization, and source selection | clean facts, answer-ready sections, strong source pages | no guaranteed citation path |
...
- facts are consistent across homepage, about, FAQ, and service pages
- structured data reinforces entity mapping
- proof assets reduce hallucination risk
