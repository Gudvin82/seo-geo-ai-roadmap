...
This section matters because discoverability grows only when page types, URL logic, hubs, internal linking are handled as an execution system rather than isolated tasks.

## When to Use

Use it for new builds, relaunches, multi-service sites. Prioritize it early if the site is launching, relaunching, or recovering from a traffic or trust problem.
...
3. Break the work into actions around page types, URL logic, hubs, internal linking.
...
Task: produce an action plan for Site Architecture with priorities, QA steps, risks, and expected outputs.
...
Example AI Agency applies Site Architecture first to audit, GEO service pages, and branded AI prompts before scaling to the full blog.
