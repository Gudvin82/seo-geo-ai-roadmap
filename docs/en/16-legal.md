...
This section matters because discoverability grows only when privacy, terms, consent, disclosures, trust alignment are handled as an execution system rather than isolated tasks.

## When to Use

Use it for commercial and lead-gen sites. Prioritize it early if the site is launching, relaunching, or recovering from a traffic or trust problem.
...
2. Break the work into actions around privacy, terms, consent, disclosures, trust alignment.
...
Task: produce an action plan for Legal Compliance with priorities, QA steps, risks, and expected outputs.
...
Example AI Agency applies Legal Compliance first to audit, GEO service pages, and branded AI prompts before scaling to the full blog.
