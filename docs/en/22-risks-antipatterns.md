...
This section matters because discoverability grows only when thin pages, mass AI content, blocked bots, false signals are handled as an execution system rather than isolated tasks.

## When to Use

Use it for all discoverability programs. Prioritize it early if the site is launching, relaunching, or recovering from a traffic or trust problem.
...
2. Break the work into actions around thin pages, mass AI content, blocked bots, false signals.
...
Task: produce an action plan for Risks and Anti-Patterns with priorities, QA steps, risks, and expected outputs.
...
Example AI Agency applies Risks and Anti-Patterns first to audit, GEO service pages, and branded AI prompts before scaling to the full blog.
