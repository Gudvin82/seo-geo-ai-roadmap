...
This section matters because discoverability grows only when authority, digital PR, mention reclamation, entity reinforcement are handled as an execution system rather than isolated tasks.

## When to Use

Use it for competitive verticals. Prioritize it early if the site is launching, relaunching, or recovering from a traffic or trust problem.
...
2. Break the work into actions around authority, digital PR, mention reclamation, entity reinforcement.
...
Task: produce an action plan for Link Building and PR with priorities, QA steps, risks, and expected outputs.
...
Example AI Agency applies Link Building and PR first to audit, GEO service pages, and branded AI prompts before scaling to the full blog.
...
- [02-competitor-analysis.md](./02-competitor-analysis.md)
- [15-serm-reputation.md](./15-serm-reputation.md)
- [23-tools.md](./23-tools.md)
