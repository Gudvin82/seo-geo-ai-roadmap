# Semantics and On-Page

> **Tags:** [U]  
> **Priority:** High  
> **Roadmap phase:** Month 1-3

## Why It Matters

This section matters because discoverability grows only when clusters, intent mapping, titles, H1, FAQs, internal anchors are handled as an execution system rather than isolated tasks.

## When to Use

Use it for all sites with search demand. Prioritize it early if the site is launching, relaunching, or recovering from a traffic or trust problem.
...
3. Break the work into actions around clusters, intent mapping, titles, H1, FAQs, internal anchors.
...
Task: produce an action plan for Semantics and On-Page with priorities, QA steps, risks, and expected outputs.
...
Example AI Agency applies Semantics and On-Page first to audit, GEO service pages, and branded AI prompts before scaling to the full blog.
