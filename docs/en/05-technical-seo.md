...
> **Tags:** [U]  
> **Priority:** High  
> **Roadmap phase:** Month 0-2

## Why It Matters

This section matters because discoverability grows only when indexability, crawling, rendering, CWV, canonicalization are handled as an execution system rather than isolated tasks.

## When to Use

Use it for all sites, especially JS-heavy and large websites. Prioritize it early if the site is launching, relaunching, or recovering from a traffic or trust problem.
...
3. Break the work into actions around indexability, crawling, rendering, CWV, canonicalization.
...
Task: produce an action plan for Technical SEO with priorities, QA steps, risks, and expected outputs.
...
Example AI Agency applies Technical SEO first to audit, GEO service pages, and branded AI prompts before scaling to the full blog.
