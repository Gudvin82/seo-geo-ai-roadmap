...
This section matters because discoverability grows only when completion criteria for pages, releases, QA, measurement are handled as an execution system rather than isolated tasks.

## When to Use

Use it for any team that ships repeatedly. Prioritize it early if the site is launching, relaunching, or recovering from a traffic or trust problem.
...
3. Break the work into actions around completion criteria for pages, releases, QA, measurement.
...
Task: produce an action plan for Definition of Done with priorities, QA steps, risks, and expected outputs.
...
Example AI Agency applies Definition of Done first to audit, GEO service pages, and branded AI prompts before scaling to the full blog.
