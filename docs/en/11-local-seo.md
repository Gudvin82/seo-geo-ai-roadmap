...
> **Tags:** [U] [RU]  
> **Priority:** Medium  
> **Roadmap phase:** Month 1-4

## Why It Matters

This section matters because discoverability grows only when NAP, maps, reviews, local landing pages, local schema are handled as an execution system rather than isolated tasks.

## When to Use

Use it for multi-location and city-driven demand. Prioritize it early if the site is launching, relaunching, or recovering from a traffic or trust problem.
...
2. Break the work into actions around NAP, maps, reviews, local landing pages, local schema.
...
Task: produce an action plan for Local SEO with priorities, QA steps, risks, and expected outputs.
...
Example AI Agency applies Local SEO first to audit, GEO service pages, and branded AI prompts before scaling to the full blog.
